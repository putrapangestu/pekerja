...
<head>
        ...
        <!-- Bootstrap Css -->
        <link href="{{asset('agroxa/css/bootstrap-dark.min.css')}}" rel="stylesheet" type="text/css" />
        <!-- Icons Css -->
        <link href="{{asset('agroxa/css/icons.min.css')}}" rel="stylesheet" type="text/css" />
        <!-- App Css-->
        <link href="{{asset('agroxa/css/app-dark.min.css')}}" rel="stylesheet" type="text/css" />

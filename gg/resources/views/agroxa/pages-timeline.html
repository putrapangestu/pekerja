...
<!-- Mirrored from themesbrand.com/agroxa/layouts/red/pages-timeline.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 09 Feb 2022 06:31:44 GMT -->
<head>

        <meta charset="utf-8" />
        <title>Timeline | Agroxa - Responsive Bootstrap 5 Admin Dashboard</title>
                                            ...
                                            <section id="cd-timeline" class="cd-container">
                                                ...
                                                <div class="cd-timeline-block">
                                                    ...
                                                    <div class="cd-timeline-content border right-content">
                                                        ...
                                                        <button type="button"
                                                            class="btn btn-primary waves-effect waves-light">See
                                                            more detail</button>

                                                        <span class="cd-date date-right">May 30</span>
                                                    </div>
                                                    <!-- cd-timeline-content -->
                                                </div>
                                                <!-- cd-timeline-block -->
                                                ...
                                                <div class="cd-timeline-block">
                                                    ...
                                                    <div class="cd-timeline-content border">
                                                        ...
                                                        <p class="mb-0 text-muted">Lorem ipsum dolor sit amet, consectetur
                                                            ...
                                                            ullam provident pariatur temporibus quia eos repellat ... <a
                                                                href="#" class="text-primary">Read more</a></p>
                                                ...
                                                <div class="cd-timeline-block">
                                                    ...
                                                    <div class="cd-timeline-content border right-content">
                                                        ...
                                                        <img src="assets/images/small/img-2.jpg" alt="" class="rounded"
                                                            style="width: 120px;">
                                                        <span class="cd-date date-right">Jun 14</span>
                                                    </div>
                                                    <!-- cd-timeline-content -->
                                                </div>
                                                <!-- cd-timeline-block -->
                                                ...
                                                <div class="cd-timeline-block">
                                                    ...
                                                    <div class="cd-timeline-content border right-content">
                                                        ...
                                                        <p class="mb-0 text-muted">Lorem ipsum dolor sit amet, consectetur
                                                            ...
                                                            similique earum voluptatem doloremque dolorem ipsam quae rerum quis.
                                                            Odit, itaque, deserunt corporis vero ipsum nisi eius odio natus
                                                            ullam provident pariatur temporibus quia eos repellat consequuntur
                                                            perferendis enim amet quae repudiandae quod veniam dolore possimus
                                                            rem voluptatum.</p>
                                                        <span class="cd-date date-right">Jun 30</span>
                                                    </div>
                                                    <!-- Cd-timeline-content -->
                                                </div>
                                                <!-- Cd-timeline-block -->

...
<!-- Mirrored from themesbrand.com/agroxa/layouts/red/pages-lock-screen.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 09 Feb 2022 06:31:44 GMT -->
<head>

        <meta charset="utf-8" />
        <title>Lock Screen | Agroxa - Responsive Bootstrap 5 Admin Dashboard</title>
        ...
        <div class="wrapper-page">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="p-3">
                        <h4 class="text-muted font-size-18 text-center">Locked</h4>
                        <p class="text-muted text-center">Hello Smith, enter your password to unlock the screen!</p>

                        <form class="form-horizontal" action="https://themesbrand.com/agroxa/layouts/red/index.html">

                            <div class="user-thumb text-center">
                                <img src="assets/images/users/avatar-6.jpg" class="rounded-circle img-thumbnail mb-2"
                                    alt="thumbnail">
                                <h6>Robert Smith</h6>
                            </div>

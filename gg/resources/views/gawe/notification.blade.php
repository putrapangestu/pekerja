...
<body>
    ...
    <div class="page-wrapper">
        ...
        <div class="site-header__header-one clearfix">
        ...
        <section class="page-header" >
            <div class="container">
                ...
                @if(Auth::user()->user == 'Perusahaan')
                    <div class="row">
                        <div class="col-1 border py-4"><i class="fas fa-envelope"></i></div>
                        <div class="col-9 border"><div class="text-danger">{{ $notif->untuk }}</div> ingin merekrut anda, ketuk untuk membalas tawaran
                            <div class="lead">yahahahahah</div>
                        </div>
                        <div class="col-2 border">adsf</div>
                    </div>
                @elseif(Auth::user()->user == 'Pekerja')
                    <div class="row">
                        <div class="col-1 border py-4"><i class="fas fa-envelope"></i></div>
                        <div class="col-9 border">{{ $notif->dari }} ingin merekrut anda
                            <div class="lead">ketuk untuk melihat detail & menanggapinya</div>
                        </div>
                        <div class="col-2 border">{{ $notif->created_at }}</div>
                    </div>
                @endif
                @endforeach
            </div>

                ...
                <div class="row">
                    <div class="col-xl-4">
                        ...
                        <div class="listings_three-page_single wow fadeInUp" data-wow-delay="0ms"
                            ...
                            <div class="listings_three-page_content">
                                <div class="title">
                                    <h3><a href="listings-details1.html">Putra Candra Pangestu<span
                                                class="fa fa-check"></span></a></h3>
                                </div>
                                <ul class="list-unstyled listings_three-page_contact_info">
                                    <li><i class="fas fa-map-marker-alt"></i>Malang</li>
                                    <li><i class="fas fa-user"></i>designer</li>
                    ...
                    <div class="col-xl-4">
                        ...
                        <div class="listings_three-page_single wow fadeInUp" data-wow-delay="0ms"
                            ...
                            <div class="listings_three-page_content">
                                <div class="title">
                                    <h3><a href="listings-details1.html">Monkey D mulyadi<span
                                                class="fa fa-check"></span></a></h3>
                                </div>
                                <ul class="list-unstyled listings_three-page_contact_info">
                    ...
                    <div class="col-xl-4">
                        ...
                        <div class="listings_three-page_single wow fadeInUp" data-wow-delay="0ms"
                            ...
                            <div class="listings_three-page_content">
                                <div class="title">
                                    <h3><a href="listings-details1.html">Muhammad levi bukhori<span
                                                class="fa fa-check"></span></a></h3>
                                </div>
                                <ul class="list-unstyled listings_three-page_contact_info">
                    ...
                    <div class="col-xl-4">
                        ...
                        <div class="listings_three-page_single wow fadeInUp" data-wow-delay="0ms"
                            ...
                            <div class="listings_three-page_content">
                                <div class="title">
                                    <h3><a href="listings-details1.html">Eren santoso<span
                                                class="fa fa-check"></span></a></h3>
                                </div>
                                <ul class="list-unstyled listings_three-page_contact_info">
                    ...
                    <div class="col-xl-4">
                        ...
                        <div class="listings_three-page_single wow fadeInUp" data-wow-delay="0ms"
                            ...
                            <div class="listings_three-page_content">
                                <div class="title">
                                    <h3><a href="listings-details1.html">ahmad saitama<span
                                                class="fa fa-check"></span></a></h3>
                                </div>
                                <ul class="list-unstyled listings_three-page_contact_info">
                    ...
                    <div class="col-xl-4">
                        ...
                        <div class="listings_three-page_single wow fadeInUp" data-wow-delay="0ms"
                            ...
                            <div class="listings_three-page_content">
                                <div class="title">
                                    <h3><a href="listings-details1.html">siti sakura<span
                                                class="fa fa-check"></span></a></h3>
                                </div>
                                <ul class="list-unstyled listings_three-page_contact_info">
                                    <li><i class="fas fa-map-marker-alt"></i>Malang</li>
